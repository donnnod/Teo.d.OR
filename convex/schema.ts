...
export default defineSchema({
  ...
  tradingIdeas: defineTable({
    ...
    // Multi-asset + Teo integration fields
    asset: v.optional(v.string()), // symbol e.g. "PAXGUSDT", "BTCUSDT"
    teoScore: v.optional(v.number()), // Teo confidence score 0-100
    teoRegime: v.optional(v.string()), // Teo regime tag e.g. "trend_up"
